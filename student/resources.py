...
class StudentAffResource(resources.ModelResource):
    ...
    class Meta:
        ...
        'mother_mobile','father_mobile','email','father_id','father_name','father_job','mother_name','mother_job','payment_status','global_code','document_status','contact_status','is_over','notes','admission_id')
