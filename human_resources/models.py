...
class Employee(models.Model):
    ...
    basic_certificate = models.CharField(max_length=62, blank=True, null=True,verbose_name='المؤهل الاساسي')
    ...
    notes = models.TextField( max_length=160,null=True,blank=True,verbose_name='ملاحظات ')
